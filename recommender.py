...
def calculate_user_rating_predictions(_start, _end, _user_profiles, new_user_profiles, _convnet_similarity_matrix,
    ...
    # ln = len(_user_profiles.iloc[_start:_end])
    # print "AVG Time LL:", avg_time_ll / ln
    # print "AVG Time Deep:", avg_time_deep / ln
    # print "AVG Time Synopsis:", avg_time_synopsys / ln
    # print "AVG Time Tag:", avg_time_tag / ln
    # print "AVG Time item-collaborative:", avg_time_item_collaborative / ln
    # print "AVG Time user-collaborative:", avg_time_user_collaborative / ln
    # print "AVG Time weighted-hybrid:", avg_time_weighted_hybrid / ln
    # print "AVG Time switching-hybrid:", avg_time_switching_hybrid / ln
